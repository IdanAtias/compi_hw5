...
static const char *const yytname[] =
{
  ...
  "M", "N", "setIsAssignment", YY_NULLPTR
};
#endif
...
{
    -109,    24,   127,  -109,    34,    35,    37,    39,   107,  -109,
      51,    48,    41,     2,  -109,     2,    53,  -109,  -109,    -2,
      56,    42,    67,   127,  -109,  -109,  -109,  -109,  -109,  -109,
      64,     2,  -109,  -109,  -109,    18,     2,  -109,   125,     2,
    -109,   125,  -109,    18,    69,    73,    74,  -109,  -109,   103,
    ...
    -109,   110,   141,    86,    70,  -109,   130,   127,    18,  -109,
...
{
    -109,  -109,   152,    -8,    71,  -109,  -109,   -33,  -109,  -109,
     137,  -109,   -14,  -109,   -55,  -109,  -109,  -109,  -109,  -109,
    -108,  -109,   -52,  -104,   108
};
...
static const yytype_int16 yytable[] =
{
     ...
     129,    87,    53,   128,     3,    35,    24,    25,    26,    55,
      56,    57,    58,    59,    60,    61,    71,    13,    14,    36,
      15,    17,    16,    76,    77,    78,    79,    80,   107,    24,
      25,    26,    27,    23,    84,    60,    61,   115,    72,    28,
      88,    89,   120,    19,    20,    21,   121,    42,   122,   105,
      46,    47,    98,    22,    48,   114,    65,   111,    50,    99,
      66,    67,   104,    73,    55,    56,    57,    58,    59,    60,
...
static const yytype_int16 yycheck[] =
{
     ...
     128,    73,    36,   127,     0,    23,     8,     9,    10,    30,
      31,    32,    33,    34,    35,    36,    29,     3,     3,    37,
       3,    49,     3,    57,    58,    59,    60,    61,   100,     8,
       9,    10,    11,     5,    68,    35,    36,   112,     4,    18,
      74,    75,   117,    12,    13,    14,   118,    14,   120,     7,
      14,    29,    86,    22,     7,   108,     7,     7,    14,    87,
       7,     7,    96,     4,    30,    31,    32,    33,    34,    35,
...
static const yytype_uint8 yystos[] =
{
      ...
      13,    14,    22,     5,     8,     9,    10,    11,    18,    45,
      46,     3,    14,    16,    17,    23,    37,    48,    50,    60,
      47,    50,    14,    49,    14,    15,    14,    29,     7,    40,
      14,    50,    45,    50,    52,    30,    31,    32,    33,    34,
      35,    36,    48,    61,    45,     7,     7,     7,    62,     6,
...
#line 105 "hw5.ypp" /* yacc.c:1646  */
    {
					...
					if (isTemperture((yyvsp[-5]).type)){
						(yyvsp[-1]).place = genConversionCode((yyvsp[-1]), (yyvsp[-5]).type);
					}
...
#line 133 "hw5.ypp" /* yacc.c:1646  */
    {
					...
					string idType = findVarType((yyvsp[-4]).id);
					if (idType == string("")) {
						errorUndef(yylineno, (yyvsp[-4]).id.c_str());
						exit(1);
					}
					...
					findAndSetVarIsAssigned((yyvsp[-4]).id, true);
					ostringstream os;
					if (isTemperture((yyvsp[-4]).type)){
						(yyvsp[-1]).place = genConversionCode((yyvsp[-1]), (yyvsp[-4]).type);
					}
					os << "s[" << findVarOffset((yyvsp[-4]).id) << "]" << "=" << (yyvsp[-1]).place;
					emit(os.str());
					(yyval).nextlist = list<int>();
